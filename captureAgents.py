...
class GenesAgent(CaptureAgent):
    ...
    def chooseAction(self, gameState):
        ...
        self.curPathDist = self.getMazeDistance(curPos, self.startingPos)
        if self.maxPathDist is None or self.curPathDist > self.maxPathDist:
            self.maxPathDist = self.curPathDist
